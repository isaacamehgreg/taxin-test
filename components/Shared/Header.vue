<template>
  <div class="header d-sm-flex align-center justify-sm-center justify-md-space-between mx-12">
    <NuxtLink to="/"><img src="@/assets/images/logo.png" class="social-icon" alt=""></NuxtLink>
